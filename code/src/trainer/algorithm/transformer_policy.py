import torch
import numpy as np
from src.trainer.utils.util import update_linear_schedule, get_shape_from_obs_space, get_shape_from_act_space, check
from src.trainer.algorithm.ma_transformer import MultiAgentTransformer
...
class TransformerPolicy:
    ...
    def __init__(self, args, obs_space, cent_obs_space, act_space, num_agents, device=torch.device("cpu")):
        ...
        if self.algorithm_name in ["mat", "mat_dec"]:
            from src.trainer.algorithm.ma_transformer import MultiAgentTransformer as MAT
        else:
    ...
    def save(self, save_dir, episode):
        ...
        print('Saved model in dir:', str(save_dir) + "/transformer_" + str(episode) + ".pt")
