...
from src.trainer.utils.util import check, init
from src.trainer.utils.transformer_act import discrete_autoregreesive_act, discrete_parallel_act, continuous_autoregreesive_act, continuous_parallel_act
        ...
        if self.dec_actor:
            if self.share_actor:
                ...
                for n in range(n_agent):
                    print('Creating independent actors')
